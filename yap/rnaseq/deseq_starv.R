...
write.csv(as.data.frame(resOrdered), file = "yapko_starv_deseqDE.csv")
...
library(writexl)
write_xlsx(a9_yap_common,"a9_yap_starv_common.xlsx")
...
write_xlsx(a9_yap_drxn,"a9_yapstr_samedir.xlsx")
